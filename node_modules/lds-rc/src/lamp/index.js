...
import PickerColorBase from '../picker/color/base';
import PickerColorColour from '../picker/color/colour';
import PickerColorTemperature from '../picker/color/temperature';
import SwitchNormal from '../switch/normal';
import SliderBrightness from '../slider/brightness';
...
class Lamp extends Component {
  constructor(props) {
    ...
    let CCT = value / 100 * (6500-2700) + 2700;
    this.setState({ CCT });
    console.log(value, CCT);
  }
    ...
    return (
      <div className="lamp default">
        <div>
	        ...
	        <div style={{display: "inline-block", width: "50%"}}>
	        	<PickerColorTemperature value={this.state.CCT} bgClass="lamp-cct bg" disabled={!OnOff}
	        		outR={helper.RemToPx("21.67rem") / 3}
	        		intR={helper.RemToPx("10.1rem") / 3}
	        		barR={helper.RemToPx("2.67rem") / 3}
	        		onChange={this.handleChangePicker}>
